...
%description
Gopa (Good Old Preupgrade Assistant) is a fork of the Preupgrade
Assistant framework originally developed for in-place upgrades to RHEL7.
It is designed to run the Preupgrade Assistant modules, which analyze
the system for possible in-place upgrade limitations. It is based on a
modular system, with each module performing a separate test, checking
for package removals, incompatible obsolete packages, changes in
libraries, users, groups, services, or incompatibilities of command-line
options or configuration files. It is able to execute post-upgrade
scripts to finalize complex tasks after the system upgrade.  It then
produces a report, which assists you in performing the upgrade itself by
outlining potential problem areas and by offering suggestions about
mitigating any possible incompatibilities. 
...
%changelog
* Wed Jul 13 2022 Bob Mader <bmader@redhat.com> - 2.6.2-2
- Repackaging for Gopa fork

* Wed Nov 16 2016 Michal Bocek <mbocek@redhat.com> - 2.6.2-1
